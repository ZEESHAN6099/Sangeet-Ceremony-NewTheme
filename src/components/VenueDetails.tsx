  ...
  return (
    <section ref={sectionRef} id="venue" className="section-container panel overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-3xl md:max-w-5xl flex-col items-center px-4">
        <div
          ref={cardRef}
          className="relative w-full rounded-[28px] border border-golden-amber/50 p-6 shadow-[0_28px_80px_rgba(0,0,0,0.6)] backdrop-blur-2xl md:p-12"
          style={{
        ...
        >
          <div className="grid items-center gap-6 md:grid-cols-2">
            <div className="z-10 space-y-8">
              <div className="text-left">
                <h2
                  ...
                  style={{
                    color: '#FFD580',
                    textShadow: '0 6px 26px rgba(255,185,15,0.95), 0 0 40px rgba(255,215,0,0.25)',
                    lineHeight: 1
                  }}
                >
                ...
                <div className="h-px w-32 bg-gradient-to-r from-golden-amber to-transparent opacity-50" />
              </div>
              ...
              <div ref={timeRef} className="flex items-center gap-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-full border border-soft-yellow/40 bg-gradient-to-br from-soft-yellow/8 to-transparent">
                  ...
                  <p className="font-montserrat text-[10px] uppercase tracking-[0.2em] text-soft-yellow/70">
                    In the Evening
                  </p>
                </div>
              </div>
              ...
              <button
                ...
                type="button"
                onClick={openMaps}
                className="group block w-full rounded-xl border border-royal-gold/20 p-4 md:p-6 text-left transition-all duration-400 hover:border-soft-yellow/40 hover:scale-[1.01]"
              ...
              >
                <div className="flex gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-soft-yellow/10 text-soft-yellow shadow-[0_0_15px_rgba(255,223,0,0.3)]">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 24 24"
              ...
              >
                <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" className="text-royal-gold">
            ...
            <div ref={archRef} className="relative group">
              <div className="relative aspect-[4/5] overflow-hidden rounded-t-full border-4 border-golden-amber/30 transition-all duration-700 group-hover:border-soft-yellow/40 group-hover:shadow-[0_0_40px_rgba(255,185,15,0.4)]">
                <img
                  src={IMAGES.VENUE_BG}
                ...
                <div className="absolute bottom-6 left-0 right-0 text-center">
                  <p className="font-pinyon text-4xl text-mustard-yellow text-magical-glow drop-shadow-lg">Razberry's</p>
                  <p className="font-cinzel text-[10px] tracking-[0.4em] text-soft-yellow/70">WEDDING VENUE</p>
                </div>
              </div>
              <div className="pointer-events-none absolute -inset-2 rounded-t-full border border-golden-amber/20" />
            </div>
          </div>
        </div>
        ...
        <div ref={carRef} className="mt-6 w-full max-w-xl">
          <button
            type="button"
            onClick={openMaps}
            className="group relative mx-auto flex w-full max-w-[30rem] items-center justify-center gap-5 overflow-hidden rounded-full border border-golden-amber/40 bg-gradient-to-r from-soft-yellow/70 via-golden-amber/80 to-mustard-yellow/70 px-6 py-3 md:px-8 md:py-4 shadow-[0_10px_30px_rgba(0,0,0,0.35)] transition-all duration-500 hover:border-soft-yellow/70 hover:shadow-[0_14px_36px_rgba(0,0,0,0.35),_0_0_40px_rgba(255,185,15,0.35)] hover:scale-[1.03]"
          >
            <div className="pointer-events-none absolute inset-[1px] rounded-full border border-cream/10" />
            <div className="pointer-events-none absolute inset-x-8 bottom-0 h-[2px] bg-gradient-to-r from-transparent via-soft-yellow/30 to-transparent" />
            <div className="pointer-events-none absolute inset-x-10 -bottom-3 h-[2px] overflow-hidden">
              <div className="flex h-full w-[200%] gap-4 animate-[road-move_0.8s_linear_infinite]">
                {[...Array(20)].map((_, i) => (
                  <div key={i} className="h-full w-4 bg-soft-yellow/50" />
                ))}
              </div>
            </div>
            ...
            <div className="relative transition-transform duration-500 group-hover:translate-x-3">
              <svg width="50" height="30" viewBox="0 0 60 40" aria-hidden="true">
                <path d="M5 25 L10 15 L18 12 L42 12 L50 15 L55 25 L55 30 L5 30 Z" fill="#FFD700" />
                <circle cx="15" cy="30" r="5" fill="#1A0F0F" stroke="#FFD700" />
                <circle cx="45" cy="30" r="5" fill="#1A0F0F" stroke="#FFD700" />
                <rect x="52" y="22" width="4" height="3" fill="#FFD580" className="animate-pulse" />
              </svg>
            </div>

            <div className="text-center">
              <span className="font-cinzel text-sm tracking-[0.35em] text-cream transition-colors group-hover:text-soft-yellow text-magical-glow">
                LOCATE ON MAP
              </span>
              <div className="mt-1 h-px w-full scale-x-0 bg-gradient-to-r from-transparent via-soft-yellow/40 via-golden-amber/40 to-mustard-yellow/40 to-transparent transition-transform duration-500 group-hover:scale-x-100" />
            </div>
          </button>
        </div>
      </div>
